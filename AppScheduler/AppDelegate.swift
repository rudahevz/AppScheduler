...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        // Pre-register the app in the Accessibility list at launch.
        // This ensures it appears immediately when the user opens the panel,
        // without needing to click any button first.
        Jiggler.shared.registerForAccessibilityIfNeeded()
